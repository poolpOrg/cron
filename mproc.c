...
void
m_add_u8(struct mproc *m, uint8_t u8)
{
	m_add(m, &u8, sizeof(u8));
};
...
void
m_get_u8(struct msg *m, uint8_t *u8)
{
	m_get(m, u8, sizeof(*u8));
}
